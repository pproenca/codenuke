...
def sample_pr():
    return {
        "number": 123,
        "url": "https://github.com/pproenca/codenuke/pull/123",
        ...
        99: [
            {
                ...
                "status": "completed",
                "conclusion": "failure",
                "html_url": "https://github.com/pproenca/codenuke/actions/runs/99/job/555",
            },
            {
                "id": 556,
                "name": "lint",
    ...
    assert failed_jobs == [
        {
            ...
            "conclusion": "failure",
            "html_url": "https://github.com/pproenca/codenuke/actions/runs/99/job/555",
            "logs_endpoint": "repos/pproenca/codenuke/actions/jobs/555/logs",
        }
    ]
