...
import { loadConfig, resolveStateDir, GlobalOptions } from "../platform/config.js";
import { detectProject } from "../platform/detect.js";
import { CodenukeError, assertDefined } from "../platform/errors.js";
...
import { nowIso, writeJson } from "../platform/fs.js";
import { changedFilesSince, discoverGit, findProjectRoot } from "../platform/git.js";
import { stableId, runId } from "../platform/id.js";
...
export async function doctorCommand(
  ...
  const loaded = await loadProjectState(context).then(
    (value) => value,
    () => null,
  );
