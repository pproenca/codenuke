...
2. **What is its real subject?** (Not "the user" — the _email system_)
...
- A `Manager`/`Coordinator` that genuinely _coordinates_ across concerns and holds the orchestration state (e.g. a saga, a transaction coordinator). That's a real role. Keep it, but be honest about it.
