...
| ---------- | ------------------------------ | ------------------------------- | --------------------------- | ----------- | --------: | --------: | ---------------: | --------: | ------- | -------------------------------------- |
| YYYY-MM-DD | Example: extract shell helpers | `run`, `scorer`, worktree setup | `loop/*.test.mjs` confirmed | `pnpm test` |        -0 |        -0 |               -0 |        -0 | planned | Replace this example with real slices. |
